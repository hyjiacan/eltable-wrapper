  ...
  methods: _objectSpread({
    ...
    _loadIncData: function _loadIncData() {
      ...
      this._sendAjax(p).then(function (data) {
        ...
        if (_this.source === 'i' && _this.pager.index === _this.pager.count) {
          // 当只有一页数据时，加载更多数据
...
/* harmony default export */ var Templatevue_type_script_lang_js_ = (ElTableWrapper_component);
