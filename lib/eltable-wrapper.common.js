...
/* harmony default export */ var privateMethods = ({
  methods: {
     ...
     */
    _sendAjax: function () {
      var _sendAjax2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(params) {
        var _this$ajax,
            _this = this;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                return _context.abrupt("return", this.ajax((_this$ajax = {
                  url: this.url,
                  method: this.method
                }, _defineProperty(_this$ajax, this.ajaxParamsName, params), _defineProperty(_this$ajax, "option", this.ajaxOptions), _this$ajax)).catch(function (e) {
    ...
    _loadIncData: function _loadIncData(beforeSend, lastId) {
      ...
      // 这么写以避免搞掉原始参数
      var p = privateMethods_objectSpread(privateMethods_objectSpread({}, this.params), {}, (_objectSpread2 = {}, _defineProperty(_objectSpread2, this.paramInc, lastId === undefined ? this._getLastId() : lastId), _defineProperty(_objectSpread2, this.paramSize, this.incSize), _objectSpread2));
    ...
    _loadPagedData: function _loadPagedData(beforeSend, newQuery) {
      ...
      // 这么写以避免搞掉原始参数
      var p = privateMethods_objectSpread(privateMethods_objectSpread({}, this.params), {}, (_objectSpread3 = {}, _defineProperty(_objectSpread3, this.paramIndex, newQuery ? 0 : this.pager.index - 1), _defineProperty(_objectSpread3, this.paramSize, this.pager.size), _objectSpread3));
...
external_commonjs_vue_commonjs2_vue_root_Vue_default.a.use(loading_default.a.directive);
