...
// CONCATENATED MODULE: ./src/components/ElTableWrapper/Template.vue?vue&type=template&id=69f4b8b0&
  ...
  methods: _objectSpread({
    ...
    _loadPagedData: function _loadPagedData() {
      ...
      this._sendAjax(p).then(function (data) {
        ...
        _this2.data.size = data[_this2.totalField];
...
var Pager_component = normalizeComponent(
  ...
  Pagervue_type_template_id_37370e26_scoped_true_render,
  Pagervue_type_template_id_37370e26_scoped_true_staticRenderFns,
  false,
  null,
  "37370e26",
  null
