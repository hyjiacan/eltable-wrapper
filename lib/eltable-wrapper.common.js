...
var component = normalizeComponent(
  ...
  Pagervue_type_template_id_1e2be6b2_scoped_true_render,
  Pagervue_type_template_id_1e2be6b2_scoped_true_staticRenderFns,
  false,
  null,
  "1e2be6b2",
  null
...
/* harmony default export */ var privateMethods = ({
  methods: {
    ...
    _invokeCheckParams: function _invokeCheckParams(param) {
      ...
      var result = this.checkParams(param, paramsDiff);
