  ...
  methods: {
    ...
    load: function load() {
      ...
      this._ajaxHandle = setTimeout(function () {
        ...
        _this._loadRemoteData(null, clear ? _this.defaultId : undefined);
      }, this.ajaxDelay);
      return this;
    },
...
/* harmony default export */ var privateMethods = ({
  methods: {
     ...
     * @private
     */
    _loadRemoteData: function _loadRemoteData(beforeSend, lastId) {
      // 禁用了分页，不传分页的相关参数
      if (this.pDisabled) {
    ...
    _loadPagedData: function _loadPagedData(beforeSend) {
      ...
      // 这么写以避免搞掉原始参数
      var p = privateMethods_objectSpread(privateMethods_objectSpread({}, this.params), {}, (_objectSpread3 = {}, _defineProperty(_objectSpread3, this.paramIndex, this.pager.index - 1), _defineProperty(_objectSpread3, this.paramSize, this.pager.size), _objectSpread3));
