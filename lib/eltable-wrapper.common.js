...
var component = {
  ...
  methods: _objectSpread({
    ...
    _loadPagedData: function _loadPagedData() {
      ...
      // 这么写以避免搞掉原始参数
      var p = Object.assign({}, this.ajaxParams, (_Object$assign2 = {}, _defineProperty(_Object$assign2, this.paramIndex, this.pager.index - 1), _defineProperty(_Object$assign2, this.paramSize, this.pager.size), _Object$assign2));
      p = this._invokeCheckParams(p);
