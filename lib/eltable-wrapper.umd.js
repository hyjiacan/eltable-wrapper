(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("element-ui/lib/theme-chalk/index.css"), require("element-ui"), require("merge"), require("deep-diff"));
	else if(typeof define === 'function' && define.amd)
		define(["element-ui/lib/theme-chalk/index.css", "element-ui", "merge", "deep-diff"], factory);
	else if(typeof exports === 'object')
		exports["ElTableWrapper"] = factory(require("element-ui/lib/theme-chalk/index.css"), require("element-ui"), require("merge"), require("deep-diff"));
	else
		root["ElTableWrapper"] = factory(root["element-ui/lib/theme-chalk/index.css"], root["element-ui"], root["merge"], root["deep-diff"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__2691__, __WEBPACK_EXTERNAL_MODULE__5f72__, __WEBPACK_EXTERNAL_MODULE__6c42__, __WEBPACK_EXTERNAL_MODULE_f097__) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2691__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__6c42__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_f097__;
...
// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=template&id=7d3b8834&
  ...
  methods: {
    ...
    remove: function remove(rows) {
      ...
      rows.forEach(function (row) {
        ...
        if (idx >= 0) {
          ...
          removeRowCount++;
        } // idx = this.selectionData.cache.findIndex(row => this.getRowId(row) === id)
        // if (idx >= 0) {
    ...
    select: function select(rows) {
      ...
      if (!this.isMultipleSelection) {
        this.$refs.table.setCurrentRow(rows); // let id = this.getRowId(rows)
      ...
      this.$nextTick(function () {
        ...
        if (_this5.isMultipleSelection) {
          ...
          _this5.currentData.forEach(function (row) {
            ...
            var selected = _this5.selectionData.all.hasOwnProperty(id);
...
/* harmony default export */ var handlers = ({
  methods: {
    ...
    onTableCurrentRowChanged: function onTableCurrentRowChanged(selected, prev) {
      ...
      this.selectionData.all = selected ? _defineProperty({}, this.getRowId(selected), selected) : {};
      this.selectionData.cache = selected ? [selected] : [];
    ...
    onTableSelectionChanged: function onTableSelectionChanged(selection) {
      ...
      var currentPageIds = this.currentData.map(function (row) {
      ...
      // 即此项已经在 selectionData.all 中，但当前的参数 selection 中不包含
      ...
      var selectedRows = [];
      var unselectedRows = [];
      this.selectionData.cache.forEach(function (row) {
        ...
        if (currentPageSelectionIds.indexOf(id) !== -1) {
          ...
          delete _this2.selectionData.all[id];
      ...
      selection.forEach(function (row) {
        ...
        if (_this2.selectionData.all[id]) {
          return;
        }
        ...
        _this2.selectionData.all[id] = row;
      });
      this.selectionData.cache = selectedRows; // 是否选择了所有数据项

      var allSelected = this.selectionData.cache.length > 0 && this.selectionData.cache.length === this.data.cache.length;
...
/* harmony default export */ var computed = ({
  computed: {
    ...
    currentSelection: function currentSelection() {
      ...
      var data = {};
      this.data.view.forEach(function (row) {
        var id = _this2.getRowId(row);

        if (_this2.selectionData.all.hasOwnProperty(id)) {
          data[id] = row;
        }
      });
      return data;
    ...
    eventHandlers: function eventHandlers() {
      ...
      var handlers = {};
      var listenEvents = ['cell-mouse-enter', 'cell-mouse-leave', 'cell-click', 'cell-dblclick', 'row-contextmenu', 'header-click', 'header-contextmenu', 'sort-change', 'filter-change', 'header-dragend', 'expand-change'];
      var vm = this;
      listenEvents.forEach(function (eventName) {
        var handler = _this3.$listeners[eventName];
