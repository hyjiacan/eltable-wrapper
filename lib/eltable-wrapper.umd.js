...
// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=template&id=205b5b74&
...
/* harmony default export */ var handlers = ({
  methods: {
    ...
    onTableSelectionChanged: function onTableSelectionChanged(selection) {
      ...
      var selectedRows = []; // const unselectedRows = []

      var unselectedIds = [];
      this.data.selection.forEach(function (row) {
      ...
      this.data.selection = selectedRows; // 是否选择了所有数据项

      var allSelected = this.data.selection.length > 0 && this.data.selection.length === this.data.cache.length;
